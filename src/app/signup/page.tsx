...
import { Globe, User, Mail, Lock, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-gray-900/40 border border-gray-800/80 rounded-2xl p-8 backdrop-blur-md shadow-2xl shadow-indigo-950/20 relative">
          <div className="mb-6">
            ...
            <p className="text-gray-400 text-sm mt-1">Start scanning and automating Facebook groups</p>
          </div>
